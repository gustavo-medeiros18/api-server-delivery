...
def test_buscar_restaurante_delega_ao_dao(monkeypatch):
    sessao = Mock()
...
def test_alterar_retorna_none_quando_restaurante_nao_existe(monkeypatch):
    sessao = Mock()
...
def test_alterar_atualiza_restaurante_com_dados_informados(monkeypatch):
    sessao = Mock()
    restaurante = Mock(spec=RestauranteModel)
...
def test_excluir_retorna_none_quando_restaurante_nao_existe(monkeypatch):
    sessao = Mock()
...
def test_excluir_rejeita_restaurante_com_pedidos(monkeypatch):
    sessao = Mock()
    restaurante = Mock(spec=RestauranteModel)
...
def test_excluir_remove_restaurante_sem_pedidos(monkeypatch):
    sessao = Mock()
    restaurante = Mock(spec=RestauranteModel)
    restaurante.pedidos = []
