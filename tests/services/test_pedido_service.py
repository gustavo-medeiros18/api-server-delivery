...
class TestPedidoService:
    ...
    def test_alterar_retorna_none_quando_pedido_nao_existe(self, monkeypatch):
        sessao = Mock()
    ...
    def test_alterar_atualiza_pedido_sem_validar_novo_restaurante(self, monkeypatch):
        sessao = Mock()
    ...
    def test_alterar_valida_restaurante_e_atualiza_pedido(self, monkeypatch):
        sessao = Mock()
        pedido = Mock(spec=PedidoModel)
    ...
    def test_alterar_rejeita_restaurante_inexistente(self, monkeypatch):
        sessao = Mock()
        pedido = Mock(spec=PedidoModel)
    ...
    def test_excluir_retorna_none_quando_pedido_nao_existe(self, monkeypatch):
        sessao = Mock()
    ...
    def test_excluir_remove_pedido_existente(self, monkeypatch):
        sessao = Mock()
        pedido = Mock(spec=PedidoModel)
